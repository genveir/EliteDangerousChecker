...
{
    private static SqlConnection GetConnection() => DbAccess.GetOpenConnection();
...
exec dbo.RecreateUpdateTables;";
    ...
    private static async Task MergeFactionAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeSolarSystemAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeSolarSystemFactionAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeSolarSystemPowerAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeSolarSystemPowerConflictProgressAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeBodiesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeStationCommoditiesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeStationEconomiesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeStationServicesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeStationsMappedToPlaceholderFactionAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeSectorPrefixAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeRingsAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeBodySignalTypesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeBodySignalGenusesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeRingSignalTypesAsync()
    {
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    private static async Task MergeRingSignalGenusesAsync()
    {
